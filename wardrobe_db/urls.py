...
from .views import image_views, search_views, metadata_views, ocr_views, stat_views, backup_views, message_views, diary_views, collection_views
...
urlpatterns = [
    ...
    path('userdict/list/', metadata_views.listUserDictionary, name='listUserDictionary'),
    path('userdict/create/', metadata_views.createUserDictionaryWord, name='createUserDictionaryWord'),
    path('userdict/delete/', metadata_views.deleteUserDictionaryWord, name='deleteUserDictionaryWord'),
    ...
    path('ocrmission/clean/', ocr_views.cleanOcrMission, name='cleanOcrMission'),
    ...
    path('collection/create/', collection_views.createCollection, name='createCollection'),
    path('collection/add/', collection_views.addCollectionItem, name='addCollectionItem'),
